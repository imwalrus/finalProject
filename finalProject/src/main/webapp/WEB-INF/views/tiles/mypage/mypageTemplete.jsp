			...
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					<li class="nav-item pcoded-hasmenu">
					    <a href="javascript:;" class="nav-link "><span class="pcoded-micon"><i class="material-icons account_box">&#xe851;</i></span><span class="pcoded-mtext">내정보 관리</span></a>
                    ...
                    <li class="nav-item pcoded-hasmenu">
					    <a href="javascript:;" class="nav-link "><span class="pcoded-micon"><i class="material-icons shopping_cart">&#xe8cc;</i></span><span class="pcoded-mtext">구매관리</span></a>
					    <ul class="pcoded-submenu">
                        ...
                        <li class="nav-item pcoded-hasmenu">
                            <a href="javascript:;" class="nav-link "><span class="pcoded-micon"><i class="material-icons agriculture">&#xea79;</i></span><span class="pcoded-mtext">농촌속으로</span></a>
                            <ul class="pcoded-submenu">
				...
				<ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item pcoded-hasmenu">
					    <a href="javascript:;" class="nav-link "><span class="pcoded-micon"><i class="material-icons store">&#xe8d1;</i></span><span class="pcoded-mtext">판매관리</span></a>
					    <ul class="pcoded-submenu">
