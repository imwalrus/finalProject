...
<script type="text/javascript">
	function showChat() {
		var pop = window.open("showChat", "chat",
				"width=1220,height=690px,resizable=no,scrollbars=no;");
	}
</script>
<body class="">
			...
			<div class="navbar-content scroll-div ">
					...
					<div class="main-menu-header">
						<div class="myMenu">
							...
							<c:if test="${user_auth == 'user'}">
								<p>
									<strong>일반 유저</strong> 권한 입니다.
								</p>
							</c:if>
							<c:if test="${user_auth == 'farmer'}">
								<p>
									<strong>농업인</strong> 권한 입니다.
								</p>
							</c:if>
							<a href="javascript:;" class="btn chatBtn" onclick="showChat()">CHAT
				...
				<c:if test="${user_auth =='user' }">
					<ul class="nav pcoded-inner-navbar ">
						<li class="nav-item pcoded-hasmenu"><a href="javascript:;"
							class="nav-link "><span class="pcoded-micon"><i
									class="material-icons account_box">&#xe851;</i></span><span
								class="pcoded-mtext">내정보 관리</span></a>
						...
						<li class="nav-item pcoded-hasmenu"><a href="javascript:;"
							class="nav-link "><span class="pcoded-micon"><i
									class="material-icons shopping_cart">&#xe8cc;</i></span><span
								class="pcoded-mtext">구매관리</span></a>
							<ul class="pcoded-submenu">
						...
						<li class="nav-item pcoded-hasmenu"><a href="javascript:;"
							class="nav-link "><span class="pcoded-micon"><i
									class="material-icons agriculture">&#xea79;</i></span><span0
								class="pcoded-mtext">농촌속으로</span></a>
							<ul class="pcoded-submenu">
				...
				<c:if test="${user_auth =='farmer' }">
					<ul class="nav pcoded-inner-navbar ">
						<li class="nav-item"><a href="fDiaryCalendar"
							class="nav-link "><span class="pcoded-micon"><i
									class="material-icons calendar_today">&#xe935;</i></span><span
								class="pcoded-mtext">영농일지</span></a></li>
						<li class="nav-item pcoded-hasmenu"><a href="javascript:;"
							class="nav-link "><span class="pcoded-micon">
							<i class="material-icons account_box">&#xe851;</i></span><span
								class="pcoded-mtext">내정보 관리</span></a>
							<ul class="pcoded-submenu">
								<li><a href="updateUser?user_id=${user_id }">회원정보수정</a></li>
								<li><a href="memberOut?user_id=${user_id }">회원탈퇴</a></li>

								<li><a href="getFarmsListofUser">나의 농지</a></li>
						...
						<li class="nav-item pcoded-hasmenu"><a href="javascript:;"
							class="nav-link "><span class="pcoded-micon"><i
									class="material-icons store">&#xe8d1;</i></span><span
								class="pcoded-mtext">판매관리</span></a>
							<ul class="pcoded-submenu">
						...
						<li class="nav-item pcoded-hasmenu"><a href="javascript:;"
							class="nav-link "><span class="pcoded-micon"><i
									class="material-icons agriculture">&#xea79;</i></span><span
								class="pcoded-mtext">농촌속으로</span></a>
							<ul class="pcoded-submenu">
								<li><a href="farmerIntoList?user_id=${user_id }">신청 내역
										관리</a></li>
								<li><a href="myIntoList?user_id=${user_id }">나의 신청 내역</a></li>
								<li><a href="getIntoFarmInqOfUser">체험 관련 문의</a></li>
							</ul></li>
