		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td class="h6">&nbsp;&nbsp;&nbsp;<fmt:formatNumber type="number" maxFractionDigits="3" value="${price}"/>원</td>
				</tr>
				<tr>
					<td class="h5">
						<strong>배송사</strong>
				...
				<tr>
					...
					<td></td>
					<c:set var="dcost" value="${modal.pro_dcost}"/>
					<td class="h6">&nbsp;&nbsp;&nbsp;<fmt:formatNumber type="number" maxFractionDigits="3" value="${dcost}"/>원</td>
				</tr>
				<tr>
					<td class="h5">
						<strong>수량</strong>
